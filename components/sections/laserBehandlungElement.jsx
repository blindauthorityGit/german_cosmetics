        ...
        >
            <div className="h-auto col-span-12 grid grid-cols-12 relative">
                <div className={`col-span-12  ${props.orderTop} relative z-10`}>
                    <div className="">
                        <img onLoad={() => setImageLoaded(true)} src={props.img} alt="img" />
                    </div>
                    <div className="absolute bg-lightGray w-3/4 sm:w-full h-full top-8 sm:left-8 z-[-1]"></div>
                </div>
                <div
                    data-len={props.len}
                    className={`col-span-12 lg:col-span-10 mt-8 sm:mt-0  ${props.orderBottom} ${props.animation} flex flex-col justify-center pt-8 sm:pt-24 pb-8 sm:pb-12 px-12`}
                >
