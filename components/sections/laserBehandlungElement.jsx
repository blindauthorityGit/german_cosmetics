    ...
    return (
        ...
        >
            <div className="h-auto col-span-12 grid grid-cols-12 relative">
                ...
                <div
                    data-len={props.len}
                    className={`col-span-12 sm:col-span-10 mt-8 sm:mt-0  ${props.orderBottom} ${props.animation} flex flex-col justify-center pt-8 md:pt-16 lg:pt-24 pb-8 lg:pb-12 px-12`}
                >
