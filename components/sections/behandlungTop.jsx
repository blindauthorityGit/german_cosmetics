    ...
    return (
        <MainContainer width={`${props.klasse} w-100 gap-0 mt-12  container font-europa md:px-12 2xl:px-32 `}>
            <div className="container col-span-12 grid grid-cols-12 text-left ">
                ...
                {props.preise && (
                    <>
                        <div className="col-span-12 lg:col-span-8 sm:mt-16  sm:mb-0 bg-lightGray preiseAfter p-12 preise clamp">
                            {/* <ScrollAnimation animateIn="slideInRight" animateOnce={true}> */}
                        ...
                        <div className="col-span-12 lg:col-span-8 mb-24 sm:mb-0 border p-12 preise preiseAfter clamp">
                            {/* <ScrollAnimation animateIn="slideInRight" animateOnce={true}> */}
