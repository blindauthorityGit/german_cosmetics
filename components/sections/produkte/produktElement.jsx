...
import { H3, H4 } from "../../utils/headlines";
    ...
    return (
        <div className={`w-full ${props.klasse}`}>
            <div
                ...
                className="cursor-pointer relative  group transition-all overflow-hidden"
            >
            ...
            <div className="px-8 xm:px-0">
                <H4 klasse="font-europa mt-6 ">{props.headline}</H4> <PortableText value={props.value}></PortableText>
            </div>
        </div>
    );
};
