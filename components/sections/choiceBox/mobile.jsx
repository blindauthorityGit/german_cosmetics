    ...
    return (
        <MainContainer width="container w-full h-screen items-center z-10">
            <div className="wrapper flex flex-col flex-col-reverse overflow-hidden col-span-12  h-full z-50">
                <div ref={leftRef} className="innerWrapper w-full bg-cover h-2/4 relative bg-lightGray order-last">
                    <div
                        ref={leftImgRef}
                ...
                <div ref={rightRef} className="innerWrapper relative w-full bg-cover h-2/4 ">
                    ...
                    <Link href="https://german-cosmetics.vercel.app/start">
                        <a>
                            <animated.div
                                style={opacityIn}
                                className="overlay z-10 sm:opacity-40  opacity-60 absolute w-full h-full top-0 bg-[#8c8263] "
                            ></animated.div>
                        </a>
                    </Link>
                </div>
