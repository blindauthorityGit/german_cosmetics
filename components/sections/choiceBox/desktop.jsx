...
const Desktop = (props) => {
    ...
    useEffect(() => {
        ...
        // DEFAULT VALUES
        rightImg.style.transform = "scale(0.85) translate3d(8px, 0px, 0px)";
        rightImg.style.opacity = "0.85";
        rightImgHolder.style.filter = "blur(3px)";

        leftImg.style.transform = "scale(1.1) translate3d(30px, 0px, 0px)";
            ...
            <div className="wrapper  overflow-hidden col-span-12 flex justify-center h-[800px] z-50">
                <div ref={wrapperRef} className="imgwrapper overflow-hidden relative w-[80%] xl:w-[60%] 2xl:w-[50%]">
                    ...
                    >
                        ...
                        >
                            <DefaultButtonLink
                                href="https://german-cosmetics.vercel.app/start"
                                klasse="col-span-12 w-full  hover:bg-[#70684f] m-auto  text-white border-none bg-[#8c8264] font-semibold"
                            >
                                zur Website
                            </DefaultButtonLink>
